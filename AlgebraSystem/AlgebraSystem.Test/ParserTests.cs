...
namespace AlgebraTests
{
    public class ParserTests
    {
        ...
        public void Parser_ParsesLogBraceless()
        {
            ...
            Equation expected = Equation.LnOf(Constant.From(5));
        ...
        public void Parser_ParsesLogBraces()
        {
            ...
            Equation expected = Equation.LnOf(Constant.From(52));
        ...
        public void Parser_ParsesLogCapital()
        {
            ...
            Equation expected = Equation.LnOf(Constant.From(152));
        ...
        public void Parser_ParsesChainedLogBraceless()
        {
            ...
            Equation expected = Equation.LnOf(Equation.LnOf(Constant.From(15)));
        ...
        public void Parser_ParsesLogBracelessAsOnlyNextLeaf()
        {
            ...
            Equation expected = (Variable.Y * Equation.LnOf(5) * Variable.X) + 3;
        ...
        public void Parser_ParsesSignBraceless()
        {
            ...
            Equation expected = Equation.SignOf(Constant.From(5));
        ...
        public void Parser_ParsesSignBraces()
        {
            ...
            Equation expected = Equation.SignOf(Constant.From(529));
        ...
        public void Parser_ParsesChainedSignBraceless()
        {
            ...
            Equation expected = Equation.SignOf(Equation.SignOf(Constant.From(145)));
        ...
        public void Parser_ParsesChainedSignBraces()
        {
            ...
            Equation expected = Equation.SignOf(Equation.SignOf(Constant.From(1555)));
        ...
        public void Parser_ParsesDifferentFunctions()
        {
            ...
            Equation expected = Equation.SignOf(Equation.LnOf(Constant.From(3883)));
        ...
        {
            // ARANGE
            Equation expected = (Variable.Z * Equation.Pow(Variable.Y, Constant.From((Rational)(2) / (1))) * Equation.SignOf((Equation.LnOf(Constant.From((Rational)(4971) / (5138))) + Constant.From((Rational)(3996) / (4441)) + Equation.Pow(Variable.W, Equation.Pow(Constant.From((Rational)(2401) / (4209)), Equation.SignOf(Equation.Pow(Equation.LnOf(Equation.Pow(Constant.From((Rational)(39449) / (47989)), Equation.SignOf(Variable.Z))), Equation.Pow(((Variable.Z + Constant.From((Rational)(815) / (6387)) + Variable.Y) * Constant.From((Rational)(1894) / (5563))), Constant.From((Rational)(13524) / (15523))))))) + Equation.LnOf(Equation.SignOf(Constant.From((Rational)(1368) / (19661)))))));
