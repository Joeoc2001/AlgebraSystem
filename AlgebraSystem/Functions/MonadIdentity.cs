...
namespace Algebra.Functions
{
    public class MonadIdentity : FunctionIdentity
    {
        ...
        public MonadIdentity(Variable parameter, int hashSeed, Expression atomicExpression, GetMonadDelegateDelegate getDelegate, GetMonadDerivativeDelegate getDerivative)
            : base(new List<string>() { parameter.Name }, hashSeed, atomicExpression,
